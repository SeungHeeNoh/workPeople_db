...
-- 담당자 : 노승희
-- 개인회원 11명 INSERT
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user01','$2a$10$BdHgnUc1rCzL8WgHtTIgNeq5mRNOcJ4cerSN4PRnw9b22VadJoTTS','선동일','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user02','$2a$10$rWbBJ5KGxdM/ehsQhh0n6.xvhEBeeuxjXOTvTpC0CVWOwCfX8hhQe','송종기','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user03','$2a$10$XhADJ.1B4XaNMd57ZQXuDudvb/A9GpX1m0gn2bpbzq3e3i9y5dlCu','노옹철','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user04','$2a$10$veJNpB1tkbxOVbakKtJiHOJJ2Zpzx6eVtYsYe8x4/fUbgQeLoWlNC','송은희','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user05','$2a$10$2CDNbKbr7yes4uQ3uV0p0uMeUlKB8c34AExGMQmXhOZISywpFTIou','유재식','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user06','$2a$10$KwnMV/xBsQ73MPNtsOTAZOzfjj4YdO6jmv96U3HFe0fm5GG6rtdhS','정중하','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user07','$2a$10$sFPeqLucyv4jNn.DuT1EXukJiJ6HQsLyD5tX94ZUOT/KUU70mQmH2','박나라','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user08','$2a$10$hROavo0/CYP3QLLgsh.PveDCcEAMB6m8mSXDEqhlXs38IIIFZCAhi','하이유','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user09','$2a$10$NU9SBFNIA7kXZ11dsdiLYOo9SflvCDpq75.UH7BFfGriWdsMykZTG','김해술','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user10','$2a$10$S3KIbIZhNvtG3.KVirysyO9zHxlRb3Q2HVg.ehJ./zkAGrjKTGkD6','심봉선','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'user11','$2a$10$V6AMhF0nT.Ewtr8KEvJAOOt71Eif6ReiDJ4ToGogmYAK78DbyZD9q','윤은해','01010001000','sun_di@kh.or.kr','06234','서울특별시 강남구 테헤란로14길 6','남도빌딩 2층, 3층, 4층',to_date('21/11/22','RR/MM/DD'),to_date('21/11/22','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
-- 기업회원 10명 INSERT
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser02','$2a$10$LSEwY1MKilC2VzZVAgJrS.iQ1DjdRHp5AadNSU4.4wPHsiG86crZe','임상헌치과의원','01010001000','sun_di@kh.or.kr','28597','충청북도 청주시 흥덕구 가로수로 1340-1','중앙빌딩 5층',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
...
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'3159600526',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,2);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser03','$2a$10$fJLSwHrZsHXfRFNrnLm29.wymAGFu1aOq96EXGV8X9UFPMBaUrduG','(주)엠지이노베이션','01010001000','sun_di@kh.or.kr','34132','대전 유성구 과학로124','G동 303호',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'1078190272',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,4);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN)values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser04','$2a$10$hZ3liTQwWLjsEK0A4JAhFensGn8xyKyqeujATl7zCpPKgNfddroba','대원이노베이션(주)','01010001000','sun_di@kh.or.kr','15402','경기 안산시 단원구 신길로1길82','901호',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'8498100739',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,3);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser05','$2a$10$MUCqFsE3tbcSk3iMEW6kAesbjVlAFc53ITl4J.FiQ0O1MCnuURSkC','(주)웨비나스','01010001000','sun_di@kh.or.kr','07995','서울 양천구 목동동로233-1','802호',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'1178178635',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,5);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser01','$2a$10$3kcEHrp3kRVo1lJ502aLJe7wAyXmtTQ7xwbMQfg7sER.9ToCs2Blq','(주)호텔더원','01010001000','sun_di@kh.or.kr','63163','제주특별자치도 제주시 사장3길 33 (연동)','호텔더원',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'6168605143',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser06','$2a$10$glumjZJOxVj.9XtT0ALdwOgMT4xoLVZEG1gSSjVNEBX3tON6bLdf.','보림토건(주)','01010001000','sun_di@kh.or.kr','04969','서울 광진구 아차산로78길110,','2층',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'2078147401',null,null,0,null,null,null,null,null,'N',3,SEQ_MEMBER_NO.CURRVAL,6);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser07','$2a$10$5lbm9v..0x9eFEio2r.c8u4xy1B4AE.Up9/FluUV.MTul3j5TmUle','(주)드림잡스쿨','01010001000','sun_di@kh.or.kr','62450','광주 광산구 남동길11-19','드림잡스쿨',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'4098602607',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,7);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser08','$2a$10$.bhjnLVGIeHNM/MxBh23LO/jAGKC98aUDzZkt7kLK9cmmDDiDg4XO','쿠키미디어(주)','01010001000','sun_di@kh.or.kr','03925','서울 마포구 월드컵북로400','7층',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'1078708416',null,null,0,null,null,null,null,null,'N',4,SEQ_MEMBER_NO.CURRVAL,8);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser09','$2a$10$V1XKyGcM/8.LrYWDzvGAAuxpOjaIIUOBXkAMjrhQyCzcG01oFvxN2','(주)신한은행','01010001000','sun_di@kh.or.kr','04513','서울 중구 세종대로9길20','대경빌딩 신한은행 본점',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values (SEQ_COMPANY_INFO_NO.NEXTVAL,'2028200922',null,null,0,null,null,null,null,null,'N',1,SEQ_MEMBER_NO.CURRVAL,9);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,2,'cuser10','$2a$10$eZe/cy70HOQU.WPBvVSzmOE/Cgxfx/YbW/JpTpadcXu.e1GGsDDc.','대한상공회의소','01010001000','sun_di@kh.or.kr','04513','서울 중구 세종대로39','대한서울상공회의소',to_date('21/11/23','RR/MM/DD'),to_date('21/11/23','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,2);
Insert into COMPANY_INFO (CI_NO,CI_COMPANY_REGISTER_NUMBER,CI_CEONAME,CI_FOUNDING_DATE,CI_EMPLOYEE_NUMBER,CI_BUSINESS_DETAIL,CI_COMPANY_HISTORY,CI_COMPANY_VISION,CI_HOMEPAGE,A_NO,CI_STATUS_YN,CT_NO,M_NO,S_NO)
values(SEQ_COMPANY_INFO_NO.NEXTVAL,'1048203590',null,null,0,null,null,null,null,null,'N',1,SEQ_MEMBER_NO.CURRVAL,10);
