...
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'jhd0554','$2a$10$ev59kTtYyn2kEyF3mGKuUu9i6mAkRr5CwFNEcu96mmLuP50ikxUSi','전형돈','010-1234-5678','jun_hd@kh.or.kr','07580','서울 강서구 강서로56나길 140','102동 505호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'jzzw0559','$2a$10$wwP7pCbnmlI2HnuXfpnpEOIbPUEjqLZqN0PdFzO5cWpaCTCGKFeri','장쯔위','010-6668-2224','jang_zw@kh.or.kr','11806','경기 의정부시 오목로 168','산들마을 대림아파트 404동 1404호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'hdw0601','$2a$10$C6ic7eOUyJFXz9Uqgc3TRu.3JMoxiIyeS9rJMEk.E..uQ20BM/KkO','하동운','011-5845-6632','ha_dh@kh.or.kr','06904','서울 동작구 현충로 105','현대아파트 108동 703호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'bms0602','$2a$10$LlK7rlmPCQ/EQcXPIfgPZeCuD/94l7z9.XV1s2SnRV2mwiyBVIY9m','방명수','010-7412-7545','bang_ms@kh.or.kr','01810','서울 노원구 공릉로 264','한신 아파트 2동 417호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'daebh0604','$2a$10$X5YwvZ/D4MnHsB3J8UJd6Odg/HE5v6jK1v6vyXi8ML35yS.GYkz5.','대북혼','010-8880-8584','dae_bh@kh.or.kr','55008','전북 전주시 덕진구 건산로 125','아중대우 102동 701호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'cha_ty1201','$2a$10$1y223RBH6IcegXWhF7WD/Otmh6sVovKBfYTx0XmOUteCNTHv9n.nu','차태연','010-6464-3212','cha_ty@kh.or.kr','55085','전북 전주시 완산구 강변로 120','서안맨션 101호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'jun_jy0105','$2a$10$bqTwmEP1JR5UT3xnr0TcF.H.J962XANMcNTKgxkAqHrN0mh7IGMz2','전지연','010-3362-4442','jun_jy@kh.or.kr','35263','대전 서구 문정로90번길 60','신내두산아파트 526동 401호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'loo_or275','$2a$10$oHwpbFSrwASzWw1RRuO//eCkKYIYxfrPAXosW5q46MQOi09lIuEFO','이오리','010-2230-6545','loo_or@kh.or.kr','59721','전남 여수시 대치1길 6','경남아파트 109동 2901호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'im_sw51','$2a$10$rSpWS0CuIq1ubpV8EnlmR.zuCMJqVHtkOviH.lpybp6fQgfF3fseS','임시환','010-7898-8555','im_sw@kh.or.kr','55365','전북 완주군 이서면 갈산로 5','태영빌 2동 201호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'leeJs12','$2a$10$C5OxogrwC.JnUeFPdY8SzOqt4nW7wpTTUe9zj5nclbmevZeUGDsaC','이중석','010-7863-4444','lee_js@kh.or.kr','08327','서울 구로구 가마산로 77','현대의보 아파트 303호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'yoohj0521','$2a$10$dhAYh4tTEjwq3g5G.DL7WOaeB1/UbUNJEGZdxEyne.HFMCsX6goVu','유하진','010-3665-4488','yoo_hj@kh.or.kr','16842','경기 용인시 수지구 만현로 11','신정마을 305동 1703호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'lee_tr0524','$2a$10$.aC4hx7s4x1cjRAhLU5mpu6ppfCcbe6K8iq4tQwT6Jud354WqOq.q','이태림','010-3300-0002','lee_tr@kh.or.kr','02635','서울 동대문구 천호대로79길 47','401호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
Insert into MEMBER (M_NO,MT_NO,M_ID,M_PWD,M_NAME,M_PHONE,M_EMAIL,M_POSTCODE,M_ROADADDRESS,M_DETAILADDRESS,M_ENROLL_DATE,M_MODIFY_DATE,M_LOGIN_FAIL_COUNT,M_IS_LOCK,M_LATEST_TRY_LOGIN_DATE,M_LOCK_COUNT,M_STATUS,M_TEMP_PWD_YN) values (SEQ_MEMBER_NO.NEXTVAL,1,'jangch0551','$2a$10$WZnBmFSRdUeYe83DPwKmLeisIm1fbh0xA8vNAsxRfPAmrJB/lfDk.','장채현','010-5556-9512','jang_ch@kh.or.kr','21510','인천 남동구 간석로 1','103동 1601호',to_date('21/12/08','RR/MM/DD'),to_date('21/12/08','RR/MM/DD'),0,'N',null,0,'Y','N');
Insert into MEMBER_ROLE (M_NO,A_CODE) values (SEQ_MEMBER_NO.CURRVAL,1);
