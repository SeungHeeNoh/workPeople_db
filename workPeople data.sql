...
-- 공고 가데이터(신한은행)등록
INSERT INTO JOB_VACANCY
VALUES(SEQ_JV_NO.NEXTVAL,'[신입/칼퇴/야근없음]신한은행 야간 인바운드 상담원 채용',SYSDATE,SYSDATE,SYSDATE,DEFAULT,0,TO_DATE('2021-11-30','YYYY-MM-DD'),TO_DATE('2021-12-11','YYYY-MM-DD'),'17:00','22:00','서울시 중구',1,1,'무관',9,4,'Y','4대보험 의무가입/퇴직금/연차휴가의 기본복리 당연적용, 별도의 휴게공간 운영, 경조사 관련 경조금, 경조휴가 지급, 연3회 보로금 지급, 생일자 선물지급','무관','연령무관',0,8);
INSERT INTO JOB_VACANCY_ROLE VALUES(1,12);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(1,12);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(1,12);
...
INSERT INTO RECRUITMENT_INDUSTRY VALUES(9,13);

INSERT INTO JOB_VACANCY
VALUES(SEQ_JV_NO.NEXTVAL,'[연봉2700만/강남]신한은행 일반 사무직',SYSDATE,SYSDATE,SYSDATE,DEFAULT,1,TO_DATE('2021-12-04','YYYY-MM-DD'),TO_DATE('2021-12-16','YYYY-MM-DD'),'09:00','18:00','서울시 강남구',1,1,'무관',9,4,'Y','담당어무 : 사무업무, 기타 지원업무, 전반적인 지원관련 업무, 우대 : 금융권 사무경력 우대','무관','연령무관',2200000,2);
INSERT INTO JOB_VACANCY_ROLE VALUES(3,14);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(1,14);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(3,14);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(9,14);

INSERT INTO JOB_VACANCY
VALUES(SEQ_JV_NO.NEXTVAL,'[신한은행/강동구]대출연장 안내 상담원/ 주 5일',SYSDATE,SYSDATE,SYSDATE,DEFAULT,1,TO_DATE('2021-12-05','YYYY-MM-DD'),TO_DATE('2021-12-22','YYYY-MM-DD'),'09:00','18:00','서울시 강동구',1,1,'무관',9,4,'Y','신한은행 대출연장 상담사 모집, 대출 만기 연장 상담 업무, 금리 안내, 서류 안내, 전산처리, 녹취 등 기타 대출관련 문의사항 처리','무관','연령무관',0,8);
INSERT INTO JOB_VACANCY_ROLE VALUES(3,15);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(1,15);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(3,15);
...
INSERT INTO RECRUITMENT_INDUSTRY VALUES(9,16);

INSERT INTO JOB_VACANCY
VALUES(SEQ_JV_NO.NEXTVAL,'[신입/야근없음]신한은행 야간 상담원 채용',SYSDATE,SYSDATE,SYSDATE,DEFAULT,0,TO_DATE('2021-12-8','YYYY-MM-DD'),TO_DATE('2021-12-25','YYYY-MM-DD'),'18:00','22:00','서울시 중구',1,1,'무관',9,4,'Y','4대보험 의무가입/퇴직금/연차휴가의 기본복리 당연적용, 별도의 휴게공간 운영, 경조사 관련 경조금, 경조휴가 지급, 연3회 보로금 지급, 생일자 선물지급','무관','연령무관',0,8);
INSERT INTO JOB_VACANCY_ROLE VALUES(1,17);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(1,17);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(1,17);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(9,17);

INSERT INTO JOB_VACANCY
VALUES(SEQ_JV_NO.NEXTVAL,'[강남]신한은행 일반 사무직 채용',SYSDATE,SYSDATE,SYSDATE,DEFAULT,1,TO_DATE('2021-12-09','YYYY-MM-DD'),TO_DATE('2021-12-28','YYYY-MM-DD'),'09:00','18:00','서울시 강남구',1,1,'무관',9,4,'Y','담당어무 : 사무업무, 기타 지원업무, 전반적인 지원관련 업무, 우대 : 금융권 사무경력 우대','무관','연령무관',2200000,2);
INSERT INTO JOB_VACANCY_ROLE VALUES(3,18);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(1,18);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(3,18);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(9,18);
...
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,1);
...
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,5);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,6);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,7);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,8);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,9);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,10);
...
BEGIN
    FOR I IN 1..11
    LOOP
INSERT INTO REPORT_VACANCY VALUES (SEQ_REPORT_VACANCY_NO.NEXTVAL,I,7);
 END LOOP;
END;
/ 
BEGIN
...
BEGIN
    FOR I IN 1..11
    LOOP
INSERT INTO REPORT_VACANCY VALUES (SEQ_REPORT_VACANCY_NO.NEXTVAL,I,6);
 END LOOP;
END;
/ 
BEGIN
...
BEGIN
    FOR I IN 1..11
    LOOP
INSERT INTO REPORT_VACANCY VALUES (SEQ_REPORT_VACANCY_NO.NEXTVAL,I,16);
 END LOOP;
END;
/ 
BEGIN
...
BEGIN
    FOR I IN 1..11
    LOOP
INSERT INTO REPORT_VACANCY VALUES (SEQ_REPORT_VACANCY_NO.NEXTVAL,I,13);
 END LOOP;
END;
/ 
BEGIN
...
BEGIN
  ...
  END_DAY := '2021-11-'||(I+5);
INSERT INTO JOB_VACANCY
VALUES(SEQ_JV_NO.NEXTVAL,'디지털 커뮤니케이션 전문인력 채용'||I,TO_DATE(START_DAY,'YYYY-MM-DD'),TO_DATE(START_DAY,'YYYY-MM-DD'),TO_DATE(START_DAY,'YYYY-MM-DD'),113,0,TO_DATE(START_DAY,'YYYY-MM-DD'),TO_DATE(END_DAY,'YYYY-MM-DD'),'09:00','18:30','서울 중구 세종대로9길20',1,3,'무관',9,4,'Y','디지털 채널 전략 수립 및 콘텐츠 기획 능력 보유자 우대','멀티미디어콘텐츠제작전문가','연령무관',0,7);
INSERT INTO JOB_VACANCY_ROLE VALUES(1,SEQ_JV_NO.CURRVAL);
INSERT INTO JOB_VACANCY_ROLE VALUES(4,SEQ_JV_NO.CURRVAL);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(2,SEQ_JV_NO.CURRVAL);
INSERT INTO JOB_VACANCY_JOB_TYPE VALUES(4,SEQ_JV_NO.CURRVAL);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(1,SEQ_JV_NO.CURRVAL);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(2,SEQ_JV_NO.CURRVAL);
INSERT INTO JOB_VACANCY_EXPERIENCE_LEVEL VALUES(3,SEQ_JV_NO.CURRVAL);
INSERT INTO RECRUITMENT_INDUSTRY VALUES(5,SEQ_JV_NO.CURRVAL);
END LOOP;
END;
/
